    ...
    clips: [
      {
        ...
        cues: [
          ...
          { at: 250, text: "Set how loud it feels — honestly." },
          { at: 356, text: "It becomes a thread beside Now — not noise inside your head." },
          { at: 490, text: "Ask what it needs from you today." },
          { at: 610, text: "One small step counts." },
          { at: 700, text: "The thread quiets. You keep moving." },
        ],
      },
    ],
  },
    ...
    clips: [
      {
        ...
        to: 983,
        cues: [
          { at: 8, text: "Time is flowing — an hour every second." },
          { at: 84, text: "This thread needs one small step. Place it on today." },
          { at: 292, text: "This one is finished — integrate it into Now." },
          { at: 505, text: "What it held comes home to you." },
          { at: 668, text: "This one? Nothing can be done right now. Set it down." },
          { at: 852, text: "And this one just needs to be quieter." },
          { at: 938, text: "Every thread, answered honestly." },
        ],
      },
      {
        ...
        to: 270,
        cues: [
          { at: 12, text: "Then the days roll on — and it all restarts." },
          { at: 150, text: "Undecided threads grow louder. Tomorrow, answer again." },
        ],
      },
    ],
  },
