...
export function Balloon({ x, y, scale = 1, color, loudness = 3, onClick }: Props) {
  ...
  return (
    <g
      className="branch-endpoint balloon-end"
    ...
    >
      ...
      <path
        ...
        pointerEvents="none"
      />
      <g transform={`rotate(${tilt} -0.6 -4.6)`} pointerEvents="none">
        {/* knot */}
