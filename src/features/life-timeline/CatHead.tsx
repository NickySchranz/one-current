...
export function CatHead({ x, y, scale = 1, color, loudness = 3, onClick }: Props) {
  ...
  return (
    <g
      className="branch-endpoint cat-head"
      transform={`translate(${x - 4}, ${y}) scale(${scale})`}
      onClick={onClick}
    >
      ...
      <g transform={`rotate(${-earFlat} -3.4 -3.4)`} pointerEvents="none">
      ...
      <ellipse cx={0} cy={2.2} rx={2.6} ry={1.9} fill="#fff" opacity={0.35} pointerEvents="none" />

      {/* eyes: gold, with pupils that dilate with loudness */}
      <ellipse cx={-2.1} cy={-0.8} rx={1.25} ry={1.15} fill={IRIS} pointerEvents="none" />
      <ellipse cx={2.1} cy={-0.8} rx={1.25} ry={1.15} fill={IRIS} pointerEvents="none" />
      <ellipse cx={-2.1} cy={-0.8} rx={pupil} ry={1} fill={DARK} pointerEvents="none" />
      <ellipse cx={2.1} cy={-0.8} rx={pupil} ry={1} fill={DARK} pointerEvents="none" />
      <circle cx={-1.85} cy={-1.15} r={0.22} fill="#fff" opacity={0.9} pointerEvents="none" />
      <circle cx={2.35} cy={-1.15} r={0.22} fill="#fff" opacity={0.9} pointerEvents="none" />

      {/* nose + mouth */}
      <path d="M -0.7 1.4 L 0.7 1.4 L 0 2.3 Z" fill={NOSE} pointerEvents="none" />
      <path
        d={MOUTH}
        fill="none"
        stroke={DARK}
