...
export function DragonHead({ x, y, scale = 1, color, loudness = 3, onClick }: Props) {
  ...
  return (
    ...
    >
      ...
      <path d={INNER_MOUTH} fill={MOUTH} stroke="none" pointerEvents="none" />
      <path d={TONGUE_PATH} fill={TONGUE} stroke="none" pointerEvents="none" />

      <path d={HORN_MAIN} fill={BONE} stroke="none" pointerEvents="none" />
      <path d={HORN_LOW} fill={BONE_DIM} stroke="none" pointerEvents="none" />

      {/* neck spikes: the body colour, shaded darker */}
      <path d={NECK_SPIKES} fill={color} stroke="none" pointerEvents="none" />
      <path d={NECK_SPIKES} fill="#000" opacity={0.25} stroke="none" pointerEvents="none" />
      ...
      <path d={UPPER_TEETH} fill={BONE} stroke="none" pointerEvents="none" />

      {/* lower jaw: body colour, slightly shaded so it reads as underneath */}
      <path d={JAW} fill={color} stroke="none" pointerEvents="none" />
      <path d={JAW} fill="#000" opacity={0.18} stroke="none" pointerEvents="none" />
      <path d={LOWER_TEETH} fill={BONE} stroke="none" pointerEvents="none" />
      ...
      <circle
        ...
        pointerEvents="none"
      />
      <path d={EYE_SOCKET} fill={EYE} stroke="none" pointerEvents="none" />
      <path
