...
export function KoiFish({ x, y, scale = 1, color, loudness = 3, onClick }: Props) {
  ...
  return (
    <g
      className="branch-endpoint koi-fish"
    ...
    >
      ...
      <path d={TAIL} fill={color} opacity={0.75} stroke="none" pointerEvents="none" />
      <path d={body} fill={color} stroke="none" />
      <path d={BELLY} fill="#fff" opacity={0.5} stroke="none" pointerEvents="none" />

      <path d={PATCH_FRONT} fill={PATCH} stroke="none" pointerEvents="none" />
      <path d={PATCH_BACK} fill={PATCH} opacity={0.85} stroke="none" pointerEvents="none" />

      <path d={DORSAL} fill={color} opacity={0.7} stroke="none" pointerEvents="none" />
      <path d={PECTORAL} fill={color} opacity={0.6} stroke="none" pointerEvents="none" />
      <path
        d={GILL}
        fill="none"
        stroke="#000"
      ...
      <circle cx={0.6} cy={-1.1} r={0.75} fill={EYE} pointerEvents="none" />
      <circle cx={0.85} cy={-1.35} r={0.25} fill="#fff" pointerEvents="none" />
